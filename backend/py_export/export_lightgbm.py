...
def main():
    ...
    model_dir = os.path.join(os.path.dirname(os.path.dirname(__file__)), "models", "lightgbm")
    ...
    try:
        ...
        save_json({
            ...
            "description": "Importance des features pour LightGBM"
        }, feat_path)
    ...
    try:
        history_data = {
            ...
            "description": "Historique du coût lors de l'entraînement"
        }
