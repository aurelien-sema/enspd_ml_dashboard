"""
Export pour Logistic Regression Model
Exporte: métriques de classification, poids du modèle, training history, confusion matrix, ROC curves
"""
import os
import sys
import json
...
def main():
    print("=" * 70)
    print("EXPORT - LOGISTIC REGRESSION MODEL")
    print("=" * 70)
    ...
    # 3. Sauvegarde des poids du modèle de régression logistique
    try:
        ...
        weight_list = model.weights if hasattr(model, 'weights') else np.zeros(len(feature_names))
        ...
        save_json({
            ...
            "description": "Coefficients (poids) de la régression logistique et biais"
        }, weights_path)
    ...
    try:
        history_data = {
            ...
            "description": "Historique de la log-loss lors de l'entraînement"
        }
    ...
    print("\n" + "=" * 70)
    print("EXPORT TERMINÉ - Logistic Regression")
    print("=" * 70)
