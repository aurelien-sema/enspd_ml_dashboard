"""
Export pour XGBoost Model
Exporte: métriques de classification, feature importance, training history, ROC curves
Note: Le modèle XGBoost de ce projet est basé sur LogisticRegression, pas sur le vrai XGBoost
"""
import os
import sys
import json
...
def main():
    print("=" * 70)
    print("EXPORT - XGBOOST MODEL (LogisticRegression Backend)")
    print("=" * 70)
    ...
    print("\nTraining XGBoost (LogisticRegression backend)...")
    model = XGBoostModel()
    ...
    try:
        ...
        save_json({
            ...
            "description": "Importance des features (magnitude des poids)"
        }, feat_path)
    ...
    try:
        history_data = {
            ...
            "description": "Historique du coût lors de l'entraînement (hinge loss + L2)"
        }
